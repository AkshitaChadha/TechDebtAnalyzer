...
from app.services.priority.priority_engine import calculate_priority_scores
...
def analyze_repository(repository_path: Path) -> AnalysisResult:
    ...
    # Scan Repository
    # ----------------------------
    analysis.python_files = get_python_files(repository_path)
    complexity_metrics = []
    # ----------------------------
    # File-Level Analysis
    # ----------------------------
    ...
    # ----------------------------
    issues = run_static_analysis(repository_path)
    churn_metrics = analyze_code_churn(repository_path)
    # ----------------------------
    # Pipeline Stages
    # ----------------------------
